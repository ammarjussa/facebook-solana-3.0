...
const Header: React.FC<Props> = ({ name, url }) => {
  ...
  const style = {
    ...
    searchContainer: `flex items-center bg-[#f0f2f5] max-w-[18rem] rounded-full py-2 px-2 text-[#b0b3b8] hidden md:flex`,
    searchInput: `border-none px-[0.6rem] bg-transparent outline-none w-[18rem] text-black placeholder:text-[#b0b3b8]`,
    headerCenterContainer: `flex-1 flex items-center justify-center h-full hidden lg:flex`,
